    ...
    var Monitoring = (function () {
        ...
        app.controller('MonitoringController', function ($scope, $compile) {
            ...
            var fnPrivate = {
                ...
                LoadThongSoGiamSat: function () {
                    //public JsonResult GetThongSo(int stt, int dat, string msmay, int loaits)
                    $.post(urlGetThongSoGiamSatTinhTrang, { stt: 11, dat: -1, msmay: "-1", loaits: 1 },
                        function (data) {
                ...
                LoadGiaTri: function (STT) {
                    ...
                    $.post(urlGetGiaTri, { stt: STT, msmay: 'HCSHCM0004', msbp: '31001001', msts: '1', loai: 1 }, function (data) {
                        var i;
                        tableBody.empty();
